                    ...
                    <form onSubmit={handleSubmit(handleRegister)} className='space-y-6'>
                        ...
                        <div className='space-y-1 text-sm'>
                            ...
                            <input
                                ...
                                type='text' placeholder='Product Name' className='text-xl w-full border px-4 py-4 rounded-md border-gray-300 bg-gray-50 text-gray-800 outline-secondary' name='productname'
                        ...
                        <div className='space-y-1 text-sm'>
                            ...
                            <input {...register("phone", {
                                ...
                                type='text' placeholder='Phone' className='text-xl w-full border px-4 py-4 rounded-md border-gray-300 bg-gray-50 text-gray-800 outline-secondary appearance-none' name='phone'
                        ...
                        <div className='space-y-1 text-sm'>
                            ...
                            <input
                                ...
                                type='text' placeholder='Location' className='text-xl w-full border px-4 py-4 rounded-md border-gray-300 bg-gray-50 text-gray-800 outline-secondary' name='location'
                        ...
                        <div className='space-y-1 text-sm flex flex-col md:flex-row items-center justify-between gap-5'>
                            <div className='w-full md:w-1/2'>
                                ...
                                <input
                                    ...
                                    type='text' placeholder='$00' className='text-xl w-full border px-4 py-4 rounded-md border-gray-300 bg-gray-50 text-gray-800 outline-secondary' name='resaleprice'
                            ...
                            <div className='w-full md:w-1/2'>
                                ...
                                <input
                                    ...
                                    type='text' placeholder='$00' className='text-xl w-full border px-4 py-4 rounded-md border-gray-300 bg-gray-50 text-gray-800 outline-secondary' name='originalprice'
                            ...
                            <div className='w-full md:w-1/2'>
                                ...
                                <input
                                    ...
                                    type='text' placeholder='Years of used' className='text-xl w-full border px-4 py-4 rounded-md border-gray-300 bg-gray-50 text-gray-800 outline-secondary' name='usedyear'
